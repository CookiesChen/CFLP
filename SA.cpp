...
int sa::getCost(const vector<customer> &customers, const vector<facility> &facilities){
    int cost = 0;
    for(int i = 0; i < customerNum; i++){
...
vector<customer> sa::expel(vector<facility> & newFacilities){
...
vector<customer> sa::swapTwo(vector<facility> & facilities){
    vector<customer> newCustomers;
    newCustomers.assign(customers.begin(), customers.end());
